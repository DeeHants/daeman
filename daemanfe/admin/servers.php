...
?>
  ...
  <form action="servers.php" method="POST">
   ...
   <table>
    ...
    <tr><td>Radius authentication</td><td><input type="checkbox" name="radius" value=1<?php if ($server[0]['Radius']) { print " checked"; } ?>> <a href="../help.php#serverradius">?</a></td></tr>
...
?>
  ...
  <form action="servers.php" method="POST">
   ...
   <table>
    ...
    <tr><td>Radius authentication</td><td><input type="checkbox" name="radius" value=1> <a href="../help.php#serverradius">?</a></td></tr>
